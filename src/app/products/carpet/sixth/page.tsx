...
function Page() {
  const [alignment, setAlignment] = useState("sixth");
    ...
    <div className={sixth.mainC}>
      ...
      <div className={sixth.infoC}>
        <div className={sixth.container}>
          <div className={sixth.sliderWrapper}>
            <div className={sixth.slider}>
              <img id="slide1" src="/sixth-sample.jpg" alt="supplier-logo" />
        ...
        <div className={sixth.infoH}>
          ...
          /> */}
          <p>
            Sixth Avenue is a polyester cut pile twist carpet bringing comfort
