...
function Product() {
  ...
  let img = [
    `/Samples/Arborlok/${currentP.img_1}`,
    `/Samples/Arborlok/${currentP.img_2}`,
  ];
      ...
      <div className={product.container}>
        ...
        <div className={product.infoHolder}>
          <div className={product.holder}>
            <p>
              Arborlok combines elegance and durability to create a floor that
              is both beautiful and affordable. Using only the finest European
              materials, the installation and finish quality is unrivalled. A
              strong melamine finish is more hygienic than other finishes
              because it does not trap dirt or bacteria. It provides a low
              maintenance surface, whilst using materials certified low emission
              and environmentally friendly. With the wide range of decors there
              is a design to suit every style or taste.
            </p>
          </div>
