...
function Product() {
  ...
  let img = [
    `/Samples/Australian/${currentP.img_1}`,
    `/Samples/Australian/${currentP.img_2}`,
  ];
      ...
      <div className={product.container}>
        ...
        <div className={product.infoHolder}>
          <div className={product.holder}>
            <p>
              Taking inspiration from the look, feel and presence of real
              European Oak, the Pinaco Delication is an innovative laminate
              flooring. Tough and with a variety of colours or styles, the
              laminate flooring is stain, scratch, fade and moisture resistant.
              Pinaco Delication is also available in a variety of designer
              decors and attractive styles.
            </p>
          </div>
