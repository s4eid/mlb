...
function Page() {
  const [alignment, setAlignment] = useState("aus-timber");
    ...
    <div className={australiansT.mainC}>
      <div className={australiansT.mainNav}>
        ...
        >
          <Link href={"/products/timber/eu-aok"}>
            <ToggleButton className={australiansT.linkHolder} value="eu-aok">
              Eu Aok
            </ToggleButton>
          </Link>
          <Link href={"/products/timber/aus-timber"}>
            <ToggleButton
              className={australiansT.linkHolder}
              value="aus-timber"
            >
              Aus Timber
            </ToggleButton>
      ...
      <div className={australiansT.infoC}>
        ...
        <div className={australiansT.infoH}>
          ...
          /> */}
          <p>
            Aok Floor brings the sophistication and warmth of real timber to a
